...
public:
    ...
    virtual void append(LogLevel level, const char *text) = 0;
...
public:
    ...
    void append(LogLevel level, const char *text) override;

    /// Process a progress message
    void log_progress(float progress, const char *name, const char *formatted,
                      const char *eta, const void *ptr) override;
