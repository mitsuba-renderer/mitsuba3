...
protected:
    ...
    // consecutive values starting at pixel_index * m_channel_count
    void accum_packet(const Float *values, UInt32 pixel_index, Bool active);
    ...
    void accum_packet(const Float *values, const Float &weight,
                      UInt32 pixel_index, Bool active);
