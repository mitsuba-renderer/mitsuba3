 ...
 * 1. Texture attributes (`Shape.add_texture_attribute`), which are backed by
 *    surface-compatible fields and can have arbitrary resolution. The UV
...
public:
     ...
     *
     * \param sample
     *     A uniformly distributed 2D point on the domain \f$[0,1]^2\f$
     *
     * \return
