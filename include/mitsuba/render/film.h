...
enum class FilmFlags : uint32_t {
    ...
    /**
     * The film provides a customized \ref Film::prepare_sample() routine that implements
 ...
 * is then committed to the film using the \ref ImageBlock::put() method.
 */
...
public:
    ...
    /**
      ...
      *
      * \param channel_count
      *    Number of spectral sensitivities of the film
      *
      * \param weight
    ...
    /**
     * \brief Return an `ImageBlock` instance, whose internal representation
     ...
     *
     * The caller is responsible to invoke the \ref parameters_changed() method on
