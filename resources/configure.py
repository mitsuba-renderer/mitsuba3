...
def write_core_config_python(f, enabled, default_variant, drjit_version_requirement):
    f.write('""" This file is automatically generated from "mitsuba.conf" using the script\n')
    f.write('    "resources/configure.py". Please do not attempt to change it manually,\n')
...
if __name__ == '__main__':
    ...
    with open(os.path.join(f"{sys.argv[2]}/ext/drjit/include/drjit/fwd.h")) as f:
    ...
    output = StringIO()
    write_core_config_python(output, enabled, default_variant_python, drjit_version)
    write_to_file_if_changed(fname, output.getvalue())
