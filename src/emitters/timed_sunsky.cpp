...
.. subfigstart::
   :center:
.. subfigure:: ../../resources/data/docs/images/render/emitter_timed_sunsky.jpg
   :scale: 80%
   :caption: Render with default settings and HDR film yielding an average over a year
.. subfigend::
   :label: fig-avg-sunsky
