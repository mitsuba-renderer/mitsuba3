...
MTS_PY_EXPORT(endpoint) {
    auto endpoint = MTS_PY_CLASS(Endpoint, Object)
        ...
        // limitation in `enoki::vectorize_wrapper` (it's not possible to
        // support non-const reference arguments).

        // .def("sample_position", enoki::vectorize_wrapper(
        //      py::overload_cast<PositionSample3fP &, const Point2fP &, const Point2fP *>(
        //         &Endpoint::sample_position, py::const_)),
        //      D(Endpoint, sample_position),
        //      "p_rec"_a, "sample"_a, "extra"_a = py::none())
        ...
        // .def("sample_direction", enoki::vectorize_wrapper(
        ...
        .def("sample_direct",
             ...
             "d_rec"_a, "sample"_a)
        // .def("sample_direct", enoki::vectorize_wrapper(
        ...
        .def("eval_position", enoki::vectorize_wrapper(
             py::overload_cast<const PositionSample3f &>(
                &Endpoint::eval_position, py::const_)),
             D(Endpoint, eval_position), "p_rec"_a)
        ...
        .def("eval_direction", enoki::vectorize_wrapper(
             py::overload_cast<const DirectionSample3fP &, const PositionSample3fP &>(
                &Endpoint::eval_direction, py::const_)),
             D(Endpoint, eval_direction), "d_rec"_a, "p_rec"_a)
        ...
        .def("pdf_position", enoki::vectorize_wrapper(
             py::overload_cast<const PositionSample3fP &>(
                &Endpoint::pdf_position, py::const_)),
             D(Endpoint, pdf_position), "p_rec"_a)
        ...
        .def("pdf_direction", enoki::vectorize_wrapper(
             py::overload_cast<const DirectionSample3fP &, const PositionSample3fP &>(
                &Endpoint::pdf_direction, py::const_)),
             D(Endpoint, pdf_direction), "d_rect"_a, "p_rec"_a)
        ...
        .def("pdf_direct", enoki::vectorize_wrapper(
             py::overload_cast<const DirectSample3fP &>(
                &Endpoint::pdf_direct, py::const_)),
             D(Endpoint, pdf_direct), "d_rec"_a)
