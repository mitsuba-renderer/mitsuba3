...
MTS_PY_EXPORT(Medium) {
    ...
    auto medium = py::class_<Medium, PyMedium, Object, ref<Medium>>(m, "Medium", D(Medium))
            ...
            .def("intersect_aabb", &Medium::intersect_aabb, "ray"_a)
            .def("get_combined_extinction", &Medium::get_combined_extinction, "mi"_a, "active"_a=true)
            .def("get_scattering_coefficients", &Medium::get_scattering_coefficients, "mi"_a, "active"_a=true)
            .def("sample_interaction", &Medium::sample_interaction, "ray"_a, "sample"_a, "channel"_a, "active"_a=true)
            .def("eval_tr_and_pdf", &Medium::eval_tr_and_pdf, "mi"_a, "si"_a, "active"_a=true)
