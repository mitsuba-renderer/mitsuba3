...
MTS_PY_EXPORT(ImageBlock) {
    ...
    MTS_PY_CLASS(ImageBlock, Object)
        .def(py::init<const ScalarVector2u &, uint32_t,
             const ReconstructionFilter *, bool, bool, bool, bool, bool>(),
            "size"_a, "channel_count"_a, "rfilter"_a = nullptr,
            "border"_a = std::is_scalar_v<Float>,
            "normalize"_a = false,
            "coalesce"_a = !std::is_scalar_v<Float>,
        ...
        .def("put", py::overload_cast<const Point2f &,
            ...
            const Float &, ek::mask_t<Float>>(&ImageBlock::put),
            "pos"_a, "wavelengths"_a, "value"_a, "alpha"_a = 1.f, "weight"_a = 1, "active"_a = true,
            D(ImageBlock, put, 2))
        .def("put",
        ...
        .def("tensor", py::overload_cast<>(&ImageBlock::tensor),
             py::return_value_policy::reference_internal, D(ImageBlock, tensor));
}
