...
MTS_PY_EXPORT(warp) {
    ...
    warp.def(
        ...
        warp::uniform_disk_to_square_concentric<Point2f>, "sample"_a,
        D(warp, uniform_disk_to_square_concentric));
    ...
    warp.def(
        ...
        warp::square_to_uniform_disk_concentric_pdf<true, Point2f>, "v"_a,
        D(warp, square_to_uniform_disk_concentric_pdf));
