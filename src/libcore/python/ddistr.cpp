...
MTS_PY_EXPORT(DiscreteDistribution) {
    // TODO bind for all different Float types
    using Float = float;
    ...
    MTS_PY_STRUCT(DiscreteDistribution)
        ...
        .def("eval", vectorize<Float>(&DiscreteDistribution::eval<UInt32>),
        ...
        .def("sample", vectorize<Float>(&DiscreteDistribution::sample<Float>),
             "sample_value"_a, "active"_a = true)
        .def("sample_pdf", vectorize<Float>(&DiscreteDistribution::sample_pdf<Float>),
             "sample_value"_a, "active"_a = true)
        .def("sample_reuse", vectorize<Float>(&DiscreteDistribution::sample_reuse<Float>),
             "sample_value"_a, "active"_a = true)
        .def("sample_reuse_pdf", vectorize<Float>(&DiscreteDistribution::sample_reuse_pdf<Float>),
             "sample_value"_a, "active"_a = true)
