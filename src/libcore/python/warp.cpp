...
MTS_PY_EXPORT_VARIANTS(warp) {
    ...
    py::class_<Marginal2D0>(warp, "Marginal2D0", D(warp, Marginal2D))
        .def(py::init([](FloatArray data, bool normalize, bool build_cdf) {
                 ...
                 return Marginal2D0(Vector2u((uint32_t) data.shape(1), (uint32_t) data.shape(0)),
                                    data.data(), {}, {}, normalize, build_cdf);
             }),
             "data"_a, "normalize"_a = true, "build_cdf"_a = true)

        .def("sample",
             vectorize<Float>([](const Marginal2D0 *lw, const Vector2f &sample, bool active) {
                 return lw->sample(sample, (const Float *) nullptr, active);
             }),
             "sample"_a, "active"_a = true, D(warp, Marginal2D, sample))
        .def("invert",
            vectorize<Float>([](const Marginal2D0 *lw, const Vector2f &invert, bool active) {
                 return lw->invert(invert, (const Float *) nullptr, active);
            }),
            "sample"_a, "active"_a = true, D(warp, Marginal2D, invert))
        .def("eval",
             vectorize<Float>([](const Marginal2D0 *lw, const Vector2f &pos, bool active) {
    ...
    py::class_<Marginal2D1>(warp, "Marginal2D1")
        .def(py::init([](FloatArray data, std::vector<std::vector<Float>> param_values,
                 ...
                 return Marginal2D1(Vector2u((uint32_t) data.shape(2), (uint32_t) data.shape(1)),
        ...
        .def("sample",
             vectorize<Float>(
                 [](const Marginal2D1 *lw, const Vector2f &sample, Float param1, bool active) {
        ...
        .def("invert",
             vectorize<Float>(
                 [](const Marginal2D1 *lw, const Vector2f &invert, Float param1, bool active) {
                     Float params[1] = { param1 };
        ...
        .def("eval",
             vectorize<Float>(
                 [](const Marginal2D1 *lw, const Vector2f &pos, Float param1, bool active) {
                     Float params[1] = { param1 };
    ...
    py::class_<Marginal2D2>(warp, "Marginal2D2")
        .def(py::init([](FloatArray data, std::vector<std::vector<Float>> param_values,
                 ...
                 if (param_values.size() != 2 ||
                     ...
                     throw std::domain_error("param_values array has incorrect dimension");
                 return Marginal2D2(
                     Vector2u((uint32_t) data.shape(3), (uint32_t) data.shape(2)), data.data(),
    ...
    py::class_<Marginal2D3>(warp, "Marginal2D3")
        .def(py::init([](FloatArray data, std::vector<std::vector<Float>> param_values,
                 ...
                 if (param_values.size() != 3 ||
                     ...
                     throw std::domain_error("param_values array has incorrect dimension");
                 return Marginal2D3(
                     Vector2u((uint32_t) data.shape(4), (uint32_t) data.shape(3)), data.data(),
                     { { (uint32_t) param_values[0].size(), (uint32_t) param_values[1].size(),
        ...
        .def("invert",
             vectorize<Float>([](const Marginal2D3 *lw, const Vector2f &invert, Float param1,
                                 Float param2, Float param3, bool active) {
    ...
    py::class_<Hierarchical2D0>(warp, "Hierarchical2D0", D(warp, Hierarchical2D))
        .def(py::init([](FloatArray data, bool normalize, bool build_hierarchy) {
                 ...
                 return Hierarchical2D0(
                     Vector2u((uint32_t) data.shape(1), (uint32_t) data.shape(0)), data.data(), {},
                     {}, normalize, build_hierarchy);
             }),
             "data"_a, "normalize"_a = true, "build_hierarchy"_a = true)
        .def("sample",
             vectorize<Float>([](const Hierarchical2D0 *lw, const Vector2f &sample, bool active) {
                 return lw->sample(sample, (const Float *) nullptr, active);
             }),
             "sample"_a, "active"_a = true, D(warp, Hierarchical2D, sample))
        .def("invert",
             vectorize<Float>([](const Hierarchical2D0 *lw, const Vector2f &invert, bool active) {
                 return lw->invert(invert, (const Float *) nullptr, active);
             }),
             "sample"_a, "active"_a = true, D(warp, Hierarchical2D, invert))
        .def("eval",
             vectorize<Float>([](const Hierarchical2D0 *lw, const Vector2f &pos, bool active) {
                 return lw->eval(pos, (const Float *) nullptr, active);
             }),
    ...
    py::class_<Hierarchical2D1>(warp, "Hierarchical2D1")
        .def(py::init([](FloatArray data, std::vector<std::vector<Float>> param_values,
                 ...
                 return Hierarchical2D1(
                     Vector2u((uint32_t) data.shape(2), (uint32_t) data.shape(1)), data.data(),
        ...
        .def("sample",
             vectorize<Float>(
                 [](const Hierarchical2D1 *lw, const Vector2f &sample, Float param1, bool active) {
                     Float params[1] = { param1 };
                     return lw->sample(sample, params, active);
                 }),
        ...
        .def("invert",
             vectorize<Float>(
                 [](const Hierarchical2D1 *lw, const Vector2f &invert, Float param1, bool active) {
                     Float params[1] = { param1 };
                     return lw->invert(invert, params, active);
                 }),
        ...
        .def("eval",
             vectorize<Float>(
                 [](const Hierarchical2D1 *lw, const Vector2f &pos, Float param1, bool active) {
                     Float params[1] = { param1 };
                     return lw->eval(pos, params, active);
                 }),
