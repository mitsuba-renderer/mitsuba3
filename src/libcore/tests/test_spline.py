...
def test_eval_spline_d(variant):
    ...
    assert(ek.allclose(eval_spline_d(0, 0, 0, 0, 0),   (0.0, 0.0)))
    assert(ek.allclose(eval_spline_d(0, 0, 0, 0, 0.5), (0.0, 0.0)))
    assert(ek.allclose(eval_spline_d(0, 0, 0, 0, 1),   (0.0, 0.0)))
    assert(ek.allclose(eval_spline_d(0, 1, 1, 1, 1),   (1.0, 1.0)))
    assert(ek.allclose(eval_spline_d(0, 1, 1, 1, 0),   (0.0, 1.0)))
    assert(ek.allclose(eval_spline_d(0, 1, 1, 1, 0.5), (0.5, 1.0)))
    assert(ek.allclose(eval_spline_d(0, 0, 1, -1, 0.5)[1], 0.0))

def test_eval_spline_i(variant):
    from mitsuba.core.spline import eval_spline_i
    assert(ek.allclose(eval_spline_i(0, 0, 0, 0, 0),   (0.0, 0.0)))
    assert(ek.allclose(eval_spline_i(0, 0, 0, 0, 0.5), (0.0, 0.0)))
    assert(ek.allclose(eval_spline_i(0, 0, 0, 0, 1),   (0.0, 0.0)))
    assert(ek.allclose(eval_spline_i(0, 1, 1, 1, 0),   (0.0, 0.0)))
    assert(ek.allclose(eval_spline_i(0, 1, 1, 1, 0.5), (0.125, 0.5)))
    assert(ek.allclose(eval_spline_i(0, 1, 1, 1, 1),   (0.5, 1.0)))
...
def test_integrate_1d_uniform(variant):
    ...
    print(integrate_1d(0, 1, values))
    print(type(integrate_1d(0, 1, values)))
