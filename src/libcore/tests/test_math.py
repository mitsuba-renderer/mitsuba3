...
def test01_is_power_of_two(variant):
...
def test02_round_to_power_of_two(variant):
    from mitsuba.core import math
...
def test03_solve_quadratic(variant):
    from mitsuba.core import math
...
def test05_legendre_pd(variant):
    from mitsuba.core import math
...
def test06_legendre_pd_diff(variant):
