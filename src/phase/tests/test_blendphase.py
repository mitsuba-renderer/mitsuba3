...
def test04_eval_components(variant_scalar_rgb):
    ...
    assert dr.allclose(value0, expected_value0)
    assert dr.allclose(pdf0, expected_pdf0)
    ...
    assert dr.allclose(value1, expected_value1)
    assert dr.allclose(pdf1, expected_pdf1)
