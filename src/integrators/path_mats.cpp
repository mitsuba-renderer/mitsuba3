...
class PathMatsIntegrator : public MonteCarloIntegrator<Float, Spectrum> {
public:
    MI_IMPORT_BASE(MonteCarloIntegrator, m_max_depth, m_rr_depth, m_hide_emitters)
    MI_IMPORT_TYPES(Scene, Sampler, Medium, Emitter, EmitterPtr, BSDF, BSDFPtr)

    PathMatsIntegrator(const Properties &props) : Base(props) { }
...
MI_IMPLEMENT_CLASS_VARIANT(PathMatsIntegrator, MonteCarloIntegrator)
MI_EXPORT_PLUGIN(PathMatsIntegrator, "Path Tracer integrator");
