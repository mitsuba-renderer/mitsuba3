...
class PathEmIntegrator : public MonteCarloIntegrator<Float, Spectrum> {
public:
    MI_IMPORT_BASE(MonteCarloIntegrator, m_max_depth, m_rr_depth, m_hide_emitters)
    MI_IMPORT_TYPES(Scene, Sampler, Medium, Emitter, EmitterPtr, BSDF, BSDFPtr)

    PathEmIntegrator(const Properties &props) : Base(props) { }
    ...
    std::string to_string() const override {
        return tfm::format("PathEmIntegrator[\n"
            "  max_depth = %u,\n"
            "  rr_depth = %u\n"
...
MI_IMPLEMENT_CLASS_VARIANT(PathEmIntegrator, MonteCarloIntegrator)
MI_EXPORT_PLUGIN(PathEmIntegrator, "Path Tracer integrator");
