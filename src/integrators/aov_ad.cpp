...
class AOVADIntegrator final : public SamplingIntegrator<Float, Spectrum> {
public:
    ...
    AOVADIntegrator(const Properties &props) : Base(props) {
...
protected:
    ...
    /// Combine inner integrator images and AOVS image by channel-major order
...
MI_IMPLEMENT_CLASS_VARIANT(AOVADIntegrator, SamplingIntegrator)
MI_EXPORT_PLUGIN(AOVADIntegrator, "AOV integrator");
