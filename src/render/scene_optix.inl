...
Scene<Float, Spectrum>::ray_intersect_preliminary_gpu(const Ray3f &ray,
    ...
    if constexpr (dr::is_cuda_v<Float>) {
        ...
        UInt32 hitobject_is_hit = UInt32::steal(hitobject_out[0]);
        //std::cout << "active before : " << active << std::endl;
        active &= (hitobject_is_hit != 0);
        //std::cout << "active after: " << active << std::endl;
        ...
        UInt32 shape_registry_id = UInt32::steal(shape_id_idx);
        ...
        pi.shape      =  dr::reinterpret_array<ShapePtr, UInt32>(shape_registry_id);
        pi.instance   = has_instances ? ShapePtr::steal(hitobject_out[6]) : dr::zeros<ShapePtr>();


        //std::cout << "hitobject_is_hit: " << hitobject_is_hit << std::endl;
        //std::cout << "pi.t" << pi.t << std::endl;
        //std::cout << "pi.t         : " << pi.t          << std::endl;
        //std::cout << "pi.prim_uv[0]: " << pi.prim_uv[0] << std::endl;
        //std::cout << "pi.prim_uv[1]: " << pi.prim_uv[1] << std::endl;
        //std::cout << "pi.prim_index: " << pi.prim_index << std::endl;
        //std::cout << "pi.instance  : " << pi.instance << std::endl;

        UInt32 instance_tmp = dr::reinterpret_array<UInt32, ShapePtr>(pi.instance);
        //std::cout << "instance_tmp: " << instance_tmp << std::endl;
        //std::cout << "shape_registry_id: " << shape_registry_id << std::endl;
