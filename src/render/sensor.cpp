...
Sensor<Float, Spectrum>::sample_ray_differential(Float time, Float sample1, const Point3f &sample2,
    ...
    Vector3f dx(1.f / m_resolution.x(), 0.f, 0.f);
    Vector3f dy(0.f, 1.f / m_resolution.y(), 0.f);
