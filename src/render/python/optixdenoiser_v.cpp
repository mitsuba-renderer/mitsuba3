...
MI_PY_EXPORT(OptixDenoiser) {
    ...
    MI_PY_CLASS(OptixDenoiser, Object)
        .def(py::init<const ScalarVector2u &, bool, bool, bool, bool>(),
        ...
        .def(
            ...
            [](const OptixDenoiser &denoiser, const TensorXf &noisy,
               ...
               const py::object &transform, const TensorXf &flow,
            ...
            "to_sensor"_a = py::none(), "flow"_a = TensorXf(),
        ...
        .def(
            ...
            [](const OptixDenoiser &denoiser, const ref<Bitmap> &noisy,
               ...
               const py::object &transform, const std::string &flow_ch,
            ...
            "to_sensor"_a = py::none(), "flow_ch"_a = "",
