...
class UtilTest(unittest.TestCase):
    def test01_timeString(self):
        ...
        self.assertEqual(timeString(2 * 1000 * 60 * 60 * 24,
                                    precise=True), '2d')
        self.assertEqual(timeString(2 * 1000 * 60 * 60 * 24 * 7,
                                    precise=True), '2w')
        self.assertEqual(timeString(2 * 1000 * 60 * 60 * 24 * 7 * 52.1429,
                                    precise=True), '2y')
