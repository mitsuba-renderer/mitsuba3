...
def test02_chi2_rough_grazing(variants_vec_rgb):
    from mitsuba.core import ScalarVector3f
...
def test03_chi2_rough_beckmann_all(variants_vec_rgb):
    from mitsuba.core import ScalarVector3f
    xml = """<float name="alpha" value="0.5"/>
...
def test04_chi2_rough_beckmann_visible(variants_vec_rgb):
    from mitsuba.core import ScalarVector3f
    xml = """<float name="alpha" value="0.5"/>
...
def test05_chi2_rough_ggx_all(variants_vec_rgb):
    from mitsuba.core import ScalarVector3f
    xml = """<float name="alpha" value="0.5"/>
             <boolean name="sample_visible" value="false"/>
...
def test06_chi2_rough_ggx_visible(variants_vec_rgb):
    from mitsuba.core import ScalarVector3f
    xml = """<float name="alpha" value="0.5"/>
             <boolean name="sample_visible" value="true"/>
             <string name="distribution" value="ggx"/>
...
def test07_chi2_rough_from_inside(variants_vec_rgb):
    from mitsuba.core import ScalarVector3f
    xml = """<float name="alpha" value="0.5"/>"""
...
def test08_chi2_rough_from_inside_tir(variants_vec_rgb):
    from mitsuba.core import ScalarVector3f
    xml = """<float name="alpha" value="0.5"/>"""
    wi = ek.normalize(ScalarVector3f(0.8, 0.3, -0.05))
    sample_func, pdf_func = BSDFAdapter("roughdielectric", xml, wi=wi)
...
def test09_chi2_rough_from_denser(variants_vec_rgb):
    from mitsuba.core import ScalarVector3f
    xml = """<float name="alpha" value="0.5"/>
...
def test10_chi2_lobe_refl(variants_vec_rgb):
    from mitsuba.core import ScalarVector3f
...
def test11_chi2_aniso_lobe_trans(variants_vec_rgb):
    from mitsuba.core import ScalarVector3f
    from mitsuba.render import BSDFContext
