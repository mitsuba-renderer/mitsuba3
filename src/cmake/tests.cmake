...
if (NOT MITSUBA_PYTEST_FOUND)
  ...
  if (MITSUBA_EXEC_PYTHON_ERR_1)
    message(WARNING "Running the tests requires pytest.  Please install it manually (try: ${PYTHON_EXECUTABLE} -m pip install 'pytest>=3.0.0' pytest-xdist)")
  else()
    ...
    if (NOT WIN32 AND MITSUBA_EXEC_PYTHON_ERR_2)
      message(WARNING "Running the tests requires pytest-xdist (in addition to pytest).  Please install it manually (try: ${PYTHON_EXECUTABLE} -m pip install pytest-xdist)")
    else()
