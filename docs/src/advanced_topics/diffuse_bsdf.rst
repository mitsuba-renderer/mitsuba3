...
the :ref:`Direct illumination integrator <integrator-direct>`, extending the :code:`BSDF` base class. The code is very similar to the
...
instances. After that, we can use our new BSDF in a scene by specifying
