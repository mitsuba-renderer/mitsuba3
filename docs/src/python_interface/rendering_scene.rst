...
The :code:`raw` argument in :code:`film.bitmap()` specifies that we are interested in the raw
data of the film in order to convert it ourself into the desired format. When passing :code:`False`,
