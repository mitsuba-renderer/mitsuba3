...
While this being one of the simplest possible integrators to write, it can serve as a starting point
to write more complex integrators.
...
In this example we use the packet version of Mitsuba. This means all calls to Mitsuba functions will
be vectorized and we avoid expensive for-loops in Python.
