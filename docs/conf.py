...
# -*- coding: utf-8 -*-
#
# Mitsuba 2 documentation build configuration file, created by
...
exclude_patterns = ['.build', 'release.rst', 'src/plugin_reference/section_bsdf.rst', 'src/plugin_reference/section_emitter.rst']
