...
Path('src/bibliography.rst').touch()
...
# extensions.append('automtsclass')
...
# Display both class docstring and constructors
# autoclass_content = 'class'
autoclass_content = 'both'
# autoclass_content = '__init__'
...
def parse_overload_signature(signature):
    ...
    # Get function name
    name, signature = signature.split('(')
...
def process_overload_block(lines):
    ...
    for i, idx in enumerate(overload_indices):
        ...
        # Replace overload signature with '.. py:function::' directives
        lines[idx] = '.. py:function:: %s%s' % (name, signature)
    ...
    if what == 'class':
        ...
        if not last_name == name:  # First call (class description)
            ...
            if not cached_signature == '(overloaded)':
                ...
                lines.insert(0, '.. py:function:: %s%s' %
