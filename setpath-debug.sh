...
export PYTHONPATH="$MITSUBA_DIR/dist/python:$MITSUBA_DIR/build-debug/dist/python"
export PATH="$MITSUBA_DIR/dist:$MITSUBA_DIR/build-debug/dist:$PATH"
export LD_LIBRARY_PATH="$MITSUBA_DIR/dist:$MITSUBA_DIR/build-debug/dist:$LD_LIBRARY_PATH"
